  ...
  return (
    <main className="min-h-screen bg-[var(--teal)] px-6 py-24">
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="text-heading text-3xl sm:text-4xl text-white mb-10">Aviso Legal</h1>

        <div className="flex flex-col gap-8 text-white/70 text-base leading-relaxed">

          <section>
            <h2 className="text-heading text-lg text-white mb-3">Identificación del titular</h2>
            ...
            <ul className="flex flex-col gap-1.5 list-none m-0 p-0">
              <li><strong className="text-white">Titular:</strong> Alberto Alonso Ferrer</li>
              ...
              <li><strong className="text-white">Actividad:</strong> prestación de servicios de automatización y consultoría tecnológica basada en inteligencia artificial.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-heading text-lg text-white mb-3">Objeto</h2>
          ...
          <section>
            <h2 className="text-heading text-lg text-white mb-3">Condiciones de uso</h2>
          ...
          <section>
            <h2 className="text-heading text-lg text-white mb-3">Propiedad intelectual e industrial</h2>
          ...
          <section>
            <h2 className="text-heading text-lg text-white mb-3">Responsabilidad</h2>
          ...
          <section>
            <h2 className="text-heading text-lg text-white mb-3">Legislación aplicable y jurisdicción</h2>
